...
const routes: Routes = [
  { path: '', component: ProjectCardsListComponent },
  {
    ...
    resolve: { sequences: SequencesResolver },
    canDeactivate: [ProjectDeactivate]
  },
  { path: ':seq', component: ProjectPageComponent, resolve: { project: ProjectResolver } },
  {
    path: 'edit/:seq', component: ProjectFormComponent,
    canActivate: [AuthGuard],
    resolve: { project: ProjectResolver, sequences: SequencesResolver },
    canDeactivate: [ProjectDeactivate]
  }
];
